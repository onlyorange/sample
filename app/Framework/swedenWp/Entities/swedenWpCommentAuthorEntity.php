<?php
// The Comment Author Entity. swedenWp commentEntity class is using this.
// is this one even needed? or am I just wasting my time here? aggg...
class swedenWpCommentAuthorEntity extends swedenWpBaseEntity
{
