...
// comment entity
class swedenWpCommentEntity extends swedenWpBaseEntity
{
    ...
    public function __construct($comment, $args, $depth)
    {
        ...
        $this->author = new swedenWpCommentAuthorEntity($comment);
