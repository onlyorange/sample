...
class AviaMedia{
    ...
    function add_assets()
    {
        ...
        wp_enqueue_script('avia_media_js' , swedenBuilder::$path['assetsURL'].'js/avia-media.js' , array('avia_element_js'), $ver, TRUE );
        wp_enqueue_style( 'avia-media-style' , swedenBuilder::$path['assetsURL'].'css/avia-media.css');
    }
    ...
    function avia_media_menu_filter($strings)
    {
        ...
        if($image_only)
        {
            ...
            $strings['insertIntoPost'] = $strings['insertMediaTitle'] = __('Insert Image','swedenWp' );
        }
