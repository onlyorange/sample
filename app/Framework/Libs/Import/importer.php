...
// this can screw up whole importer big time.. in wp 3.7, importer is not part of core yet
// so let's keep load importers always true...
if ( !defined('WP_LOAD_IMPORTERS') ) define('WP_LOAD_IMPORTERS', true);

/** Display verbose errors */
// wrote the error handler separately.
...
if ( ! class_exists( 'WP_Importer' ) ) {
    ...
    return __("Import error! try to import dummy content manually from <pre>" . get_template_directory() . "/app/MKD/</pre>", 'swedenWp');
}
...
class swImportImporter extends WP_Importer {
