...
abstract class actionfilter
{
	...
	**/
	...
	/**
		...
		@details	The method prepends the text 'net_sync_' in front of the actionfilter class name.
	...
	**/
	public function apply()
	{
		...
		$actionfilter_name = 'net_sync_' . $name;
	...
	**/
	...
	/**
		...
		@details	This method means nothing to sync, only to the methods that handle this filter.
