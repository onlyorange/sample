...
/**
	@brief		Container used when networkSync data.
	@details

	This is general purpose container for storing and working with all the data necessary to sync posts.

	@since		20130530
	@version	20131015
**/
class networkSync_data
{
	/**
	...
	**/
	...
	/**
		@brief		IN: Array of child blog objects to which to sync.
		@var		$blogs
		@since		20130927
	**/
	public $blogs;
	...
	**/
	...
	/**
		@brief		IN: True if custom fields are to be synced.
		@var		$custom_fields
		@since		20130603
	**/
	...
	/**
		@brief		IN: True if the syncer wants to link this post to the child blog posts,
		@var		$link
		@since		20130603
	**/
	public $link = false;
	...
	**/
	...
	/**
		@brief		IN: True if taxonomies are to be synced to the child blogs.
		@var		$taxonomies
		@since		20130603
	**/
	...
	**/
	...
	/**
		@brief		Add a blog or blogs to which to sync.
		@param		mixed		$blog_id		A sync_data\blog object or an array of such objects.
		@return		this						Method chaining.
		@since		20130928
	**/
	public function sync_to( $blog )
	{
	...
	/**
		@brief		Convenience method to query whether there are child blogs to be synced to.
		@return		bool		True if there are child blogs to be synced to.
		@since		20130928
	**/
