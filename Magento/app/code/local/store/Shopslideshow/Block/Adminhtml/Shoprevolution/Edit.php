...
class store_shopslideshow_Block_Adminhtml_shoprevolution_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
            ...
            <tr>
                ...
                <td width="250">
                    <select id="color_class">
                        ...
                        <option value="shop_large_caption_light">shop_large_caption_light</option>
                        <option value="shop_large_caption_medium">shop_large_caption_medium</option>
                        <option value="shop_large_caption_bold">shop_large_caption_bold</option>

                        <option value="shop_caption_light">shop_caption_light</option>
                        <option value="shop_caption_medium">shop_caption_medium</option>
                        <option value="shop_caption_bold">shop_caption_bold</option>

                        <option value="shop_caption_underline_light">shop_caption_underline_light</option>
                        <option value="shop_caption_underline_medium">shop_caption_underline_medium</option>
                        <option value="shop_caption_underline_bold">shop_caption_underline_bold</option>

                        <option value="shop_small_caption_light">shop_small_caption_light</option>
                        <option value="shop_small_caption_medium">shop_small_caption_medium</option>
                        <option value="shop_small_caption_bold">shop_small_caption_bold</option>

                        <option value="shop_small_text_light">shop_small_text_light</option>
                        <option value="shop_small_text_medium">shop_small_text_medium</option>
                        <option value="shop_small_text_bold">shop_small_text_bold</option>

                        <option value="shop_medium_text_light">shop_medium_text_light</option>
                        <option value="shop_medium_text_medium">shop_medium_text_medium</option>
                        <option value="shop_medium_text_bold">shop_medium_text_bold</option>

                        <option value="shop_white_bg_light">shop_white_bg_light</option>
                        <option value="shop_white_bg_medium">shop_white_bg_medium</option>
                        <option value="shop_white_bg_bold">shop_white_bg_bold</option>
...
EOD;
	    ...
	    Mage::app()->getLayout()->getBlock('head')->addItem('js_css', 'store/fancybox/jquery.fancybox-1.3.4.css');
	    Mage::app()->getLayout()->getBlock('head')->addJs('store/jquery-1.8.2.min.js');
	    Mage::app()->getLayout()->getBlock('head')->addJs('store/jquery.noconflict.js');
	    Mage::app()->getLayout()->getBlock('head')->addJs('store/fancybox/jquery.fancybox-1.3.4.pack.js');

    }

    public function getHeaderText()
    {
        if( Mage::registry('shoprevolution_data') && Mage::registry('shoprevolution_data')->getId() ) {
