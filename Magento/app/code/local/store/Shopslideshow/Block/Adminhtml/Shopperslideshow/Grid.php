...
class store_shopslideshow_Block_Adminhtml_shopslideshow_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('shopslideshowGrid');
  ...
  {
      $collection = Mage::getModel('shopslideshow/shopslideshow')->getCollection();
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('image', array(
          ...
          'align'     =>'left',
          'index'     => 'image',
		  'renderer' => 'shopslideshow/adminhtml_shopslideshow_grid_renderer_image'
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('shopslideshow');
