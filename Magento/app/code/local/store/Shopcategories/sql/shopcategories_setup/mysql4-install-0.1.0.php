...
DROP TABLE IF EXISTS `{$this->getTable('shopcategories/scheme')}`;
CREATE TABLE `{$this->getTable('shopcategories/scheme')}` (
...
$conn->dropTable($installer->getTable('shopcategories/scheme_store'));

/**
 * Create table for stores
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('shopcategories/scheme_store'))
    ...
    ->addIndex($installer->getIdxName('shopcategories/scheme_store', array('store_id')),
    array('store_id'))
    ->addForeignKey($installer->getFkName('shopcategories/scheme_store', 'scheme_id', 'shopcategories/scheme', 'scheme_id'),
    'scheme_id', $installer->getTable('shopcategories/scheme'), 'scheme_id',
    Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->addForeignKey($installer->getFkName('shopcategories/scheme_store', 'store_id', 'core/store', 'store_id'),
