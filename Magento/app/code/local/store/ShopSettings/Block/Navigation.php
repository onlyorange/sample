...
class store_shopSettings_Block_Navigation extends Mage_Catalog_Block_Navigation
{
	                                               ...
	                                               $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
	{
		...
		if ($level == 0 && $activeChildrenCount) {
			$items_per_column = Mage::getStoreConfig('shopsettings/navigation/column_items');
