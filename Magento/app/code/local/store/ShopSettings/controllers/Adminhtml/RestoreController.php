...
class store_shopSettings_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('store/shop/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('store/shop/restore')
            ->_addBreadcrumb(Mage::helper('shopsettings')->__('Restore Defaults'), Mage::helper('shopsettings')->__('Restore Defaults'));
    ...
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('shopsettings/adminhtml_restore_edit'));
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/store/shopSettings/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/shopsettings')->children(), 'shopsettings');
            ...
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('shopsettings')->__('Default Settings for shop Theme has been restored. Please clear cache (System > Cache management) if you do not see changes in storefront'));
        }
        catch (Exception $e) {
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('shopsettings')->__('An error occurred while restoring theme settings.'));
        }
