...
class store_Priceslider_Block_Tool extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('store/priceslider/slider_toolbar.phtml');
    }
    ...
    {	
        $pagerBlock = $this->getLayout()->createBlock('priceslider/pager');
