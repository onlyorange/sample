...
$swml_dir = plugin_dir_url(__FILE__);
...
function swml_admin_enqueue_scripts() {
	...
	wp_enqueue_script(
		...
		$swml_dir . 'js/swml-media-models.js',
	...
	wp_enqueue_script(
		...
		$swml_dir . 'js/swml-media-views.js',
	...
	if ('themes.php' == $pagenow) {
		wp_enqueue_script(
			'swml-custom-header-script',
			$swml_dir . 'js/swml-custom-header.js',
		...
		wp_enqueue_script(
			'swml-custom-background-script',
			$swml_dir . 'js/swml-custom-background.js',
...
add_action( 'customize_controls_enqueue_scripts', 'swml_customize_controls_scripts' );

function swml_customize_controls_scripts() {
	global $swml_version,
	$swml_dir;
	
	wp_enqueue_script(
		'swml-customize-controls-script',
		$swml_dir . 'js/swml-customize-controls.js',
